...
public enum ModifiableText {
    ...
    ,SESSION_ACTION_TASKS(Seasons.DOUBLE_LIFE, "Assign Tasks")
    ...
    ,SECRETLIFE_TASK_MISSING(Seasons.DOUBLE_LIFE, "§cYou do not have a secret task book in your inventory.")
    ,SECRETLIFE_TASK_MISSING_OTHER(Seasons.DOUBLE_LIFE, "{} does not have a task book in their inventory nor a pre-assigned task", List.of("Player"))
    ,SECRETLIFE_TASK_PRESENT(Seasons.DOUBLE_LIFE, "{} has a task book in their inventory", List.of("Player"))
    ,SECRETLIFE_TASK_PREASSIGNED(Seasons.DOUBLE_LIFE, "{} has a pre-assigned task", List.of("Player"))
    ,SECRETLIFE_TASK_READFAIL(Seasons.DOUBLE_LIFE, "Failed to read task contents")
    ,SECRETLIFE_TASK_SHOW(Seasons.DOUBLE_LIFE, "§7Click {}§7 to show the task they have.", List.of("ClickHere"))
    ,SECRETLIFE_TASK_SHOW_PAST(Seasons.DOUBLE_LIFE, "§7Click {}§7 to see what {}§7's task was.", List.of("ClickHere", "Player"))
    ,SECRETLIFE_SECRETKEEPER_INUSE(Seasons.DOUBLE_LIFE, "§cSomeone else is using the Secret Keeper right now.")
    ,SECRETLIFE_TASK_PENDING(Seasons.DOUBLE_LIFE, "{} wants to succeed their task.", List.of("Player"))
    ,SECRETLIFE_TASK_PENDING_ACCEPT(Seasons.DOUBLE_LIFE, "§7Click {}§7 to confirm this action.", List.of("ClickHere"))
    ,SECRETLIFE_TASK_PENDING_NOTIFICATION(Seasons.DOUBLE_LIFE, "§cYour task confirmation needs to be approved by an admin.")
    ,SECRETLIFE_TASK_SUCCEED(Seasons.DOUBLE_LIFE, "{}§a succeeded their task.", List.of("Player"))
    ,SECRETLIFE_TASK_REROLL_HARD_FAIL(Seasons.DOUBLE_LIFE, "§cYou cannot re-roll a Hard task.")
    ,SECRETLIFE_TASK_REROLL_HARD_FAIL_RED(Seasons.DOUBLE_LIFE, "§cYou cannot re-roll a Hard task. If you want your red task instead, click the Fail button.")
    ,SECRETLIFE_TASK_NOT_SUBMITTED(Seasons.DOUBLE_LIFE, Formatted.LOOSELY_STYLED,"§4{}§c still {} not submitted / failed a task this session.", List.of("Players", "has/have"))
    ,SECRETLIFE_HEART_GAIN(Seasons.DOUBLE_LIFE, Formatted.LOOSELY_STYLED,"§c+{} {}", List.of("amount", "heart/hearts"))
    ,SECRETLIFE_TASK_NAME(Seasons.DOUBLE_LIFE, "{}'s Secret Task", List.of("Player"))
    ,SECRETLIFE_TASK_AUTHOR(Seasons.DOUBLE_LIFE, "Secret Keeper")
    ,SECRETLIFE_TASK_SET(Seasons.DOUBLE_LIFE, "Changed {}'s task", List.of("Player"))
    ,SECRETLIFE_TASK_PREASSIGN(Seasons.DOUBLE_LIFE, "Pre-assigned {}'s task for randomization\n§7They will be given the task book once you / the game rolls the tasks", List.of("Player"))
    ,SECRETLIFE_TASK_SET_MULTIPLE(Seasons.DOUBLE_LIFE, "Changed or pre-assigned task of {} targets", List.of("number of targets"))
    ,SECRETLIFE_TASK_SET_RANDOM_SINGLE(Seasons.DOUBLE_LIFE, "Assigning random task to {}", List.of("Player"))
    ,SECRETLIFE_TASK_SET_RANDOM_MULTIPLE(Seasons.DOUBLE_LIFE, "Assigning random tasks to {} targets", List.of("number of targets"))
    ,SECRETLIFE_TASK_REMOVE_SINGLE(Seasons.DOUBLE_LIFE, "Removed task book from {}", List.of("Player"))
    ,SECRETLIFE_TASK_REMOVE_MULTIPLE(Seasons.DOUBLE_LIFE, "Removed task book from {} targets", List.of("number of targets"))
    ,SECRETLIFE_TASK_SUCCESS_SINGLE(Seasons.DOUBLE_LIFE, "§7Succeeding task for {}§7...", List.of("Player"))
    ,SECRETLIFE_TASK_SUCCESS_MULTIPLE(Seasons.DOUBLE_LIFE, "§7Succeeding task for {}§7 targets...", List.of("number of targets"))
    ,SECRETLIFE_TASK_FAIL_SINGLE(Seasons.DOUBLE_LIFE, "§7Failing task for {}§7...", List.of("Player"))
    ,SECRETLIFE_TASK_FAIL_MULTIPLE(Seasons.DOUBLE_LIFE, "§7Failing task for {}§7 targets...", List.of("number of targets"))
    ,SECRETLIFE_TASK_REROLL_SINGLE(Seasons.DOUBLE_LIFE, "§7Rerolling task for {}§7...", List.of("Player"))
    ,SECRETLIFE_TASK_REROLL_MULTIPLE(Seasons.DOUBLE_LIFE, "§7Rerolling task for {}§7 targets...", List.of("number of targets"))
    ,SECRETLIFE_HEALTH_GET_SELF_DEAD(Seasons.DOUBLE_LIFE, "You're dead...")
    ,SECRETLIFE_HEALTH_GET_SELF(Seasons.DOUBLE_LIFE, "You have {} health", List.of("amount"))
    ,SECRETLIFE_HEALTH_GET_LIST(Seasons.DOUBLE_LIFE, "Health of targets:")
    ,SECRETLIFE_HEALTH_GET_OTHER_DEAD(Seasons.DOUBLE_LIFE, "{} is dead", List.of("Player"))
    ,SECRETLIFE_HEALTH_GET_OTHER(Seasons.DOUBLE_LIFE, "{} has {} health", List.of("Player", "amount"))
    ,SECRETLIFE_HEALTH_SET_SINGLE(Seasons.DOUBLE_LIFE, "Set {}'s health to {}", List.of("Player", "amount"))
    ,SECRETLIFE_HEALTH_SET_MULTIPLE(Seasons.DOUBLE_LIFE, "Set the health of {} targets to {}", List.of("Player", "amount"))
    ,SECRETLIFE_HEALTH_MODIFY_SINGLE(Seasons.DOUBLE_LIFE, "{} {} health {} {}", List.of("Added/Removed", "amount", "to/from", "Player"))
    ,SECRETLIFE_HEALTH_MODIFY_MULTIPLE(Seasons.DOUBLE_LIFE, "{} {} health {} {} targets", List.of("Added/Removed", "amount", "to/from", "number of targets"))
    ,SECRETLIFE_HEALTH_RESET_SINGLE(Seasons.DOUBLE_LIFE, "Reset {}'s health to the default", List.of("Player"))
    ,SECRETLIFE_HEALTH_RESET_MULTIPLE(Seasons.DOUBLE_LIFE, "Reset the health to default for {} targets", List.of("number of targets"))
    ,SECRETLIFE_TASK_REROLL(Seasons.DOUBLE_LIFE,"{}§7 re-rolled their easy task.", List.of("Player"))
    ,SECRETLIFE_TASK_FAIL(Seasons.DOUBLE_LIFE,"{}§c failed their task.", List.of("Player"))
    ,SECRETLIFE_GIVEHEART_RESET_SINGLE(Seasons.DOUBLE_LIFE, "Reset {}'s gifted hearts", List.of("Player"))
    ,SECRETLIFE_GIVEHEART_RESET_MULTIPLE(Seasons.DOUBLE_LIFE, "Reset the gifted hearts of {} targets", List.of("number of targets"))
    ,SECRETLIFE_GIVEHEART_ERROR_SELF(Seasons.DOUBLE_LIFE, "Nice Try.")
    ,SECRETLIFE_GIVEHEART_ERROR_MULTIPLE(Seasons.DOUBLE_LIFE, "You have already gifted a heart this session")
    ,SECRETLIFE_GIVEHEART_ERROR_DEAD(Seasons.DOUBLE_LIFE, "That player is not alive")
    ,SECRETLIFE_GIVEHEART_SEND(Seasons.DOUBLE_LIFE, "You have gifted a heart to {}", List.of("Player"))
    ,SECRETLIFE_GIVEHEART_RECEIVE(Seasons.DOUBLE_LIFE, "{} gave you a heart", List.of("Player"))
    ,SECRETLIFE_TASK_LOCATIONS(Seasons.DOUBLE_LIFE, "Changing Secret Life locations...")
    ,SECRETLIFE_TASK_ERROR_BOOK_MISSING(Seasons.DOUBLE_LIFE, "No task books were found")
    ,SECRETLIFE_TASK_WARNING_5MIN(Seasons.DOUBLE_LIFE, "§7Go submit / fail your secret tasks if you haven't!")
    ,SECRETLIFE_TASK_WARNING_30MIN(Seasons.DOUBLE_LIFE, "§7You better start finishing your secret tasks if you haven't already!")
    ,SECRETLIFE_TASK_TITLE(Seasons.DOUBLE_LIFE, "§cYour secret is...")
    ,SECRETLIFE_TASK_REROLL_PT1(Seasons.DOUBLE_LIFE, "§2§lThe reward is more")
    ,SECRETLIFE_TASK_REROLL_PT2(Seasons.DOUBLE_LIFE, "§a§lThe risk is great")
    ,SECRETLIFE_TASK_REROLL_PT3(Seasons.DOUBLE_LIFE, "§e§lLet me open the door")
    ,SECRETLIFE_TASK_REROLL_PT4(Seasons.DOUBLE_LIFE, "§c§lAccept your fate")
...
//ModifiableText.NAME.get(
    ...
    ,SECRETLIFE_(Seasons.DOUBLE_LIFE, "")
